        ...
        <div className="w-full max-w-[450px] bg-white rounded-xl shadow-md overflow-hidden mx-i-14 px-i-lg my-i-xl">
          ...
          <form onSubmit={handleSignIn} className="p-i-lg flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="name" className="text-sm font-medium text-slate-700">Fullname</label>
              <div className="">
                <input
                  type="text"
                  id="name"
            ...
            <p className="text-center text-sm text-slate-600 mt-i-4 pb-i-lg">
              ...
              <Link to="/signin" className="text-accent hover:text-accent/90 font-medium transition-colors">
                Sign in
              </Link>
            </p>
          </form>
